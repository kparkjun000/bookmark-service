...
const API_BASE_URL =
  "https://zerobase-bookmark-service-0aab4ffd66ec.herokuapp.com/api";
...
export const bookmarkApi = {
  ...
  getUserBookmarks: async (
    ...
    const response = await api.get(
      `/users/${userId}/bookmarks?page=${page}&size=${size}&sort=createdAt&direction=desc`
    );
    return response.data;
  },
  ...
  getFavoriteBookmarks: async (
    ...
    const response = await api.get(
      `/users/${userId}/bookmarks/favorites?page=${page}&size=${size}`
    );
    return response.data;
  },
  ...
  searchBookmarks: async (
    ...
    const response = await api.get(
      `/users/${userId}/bookmarks/search?keyword=${encodeURIComponent(
        keyword
      )}&page=${page}&size=${size}`
    );
    return response.data;
  ...
  updateBookmark: async (
    userId: number,
    bookmarkId: number,
    bookmarkData: Partial<CreateBookmarkRequest>
  ): Promise<Bookmark> => {
...
export const tagApi = {
  ...
  getBookmarksByTag: async (
    ...
    const response = await api.get(
      `/users/${userId}/bookmarks/tags/${tagId}?page=${page}&size=${size}`
    );
    return response.data;
  },
};
...
export const publicApi = {
  ...
  getPublicBookmarks: async (
    ...
    const response = await api.get(
      `/public/bookmarks?page=${page}&size=${size}`
    );
    return response.data;
  },
  ...
  extractMetadata: async (url: string): Promise<MetadataResponse> => {
    const response = await api.get(
      `/public/metadata?url=${encodeURIComponent(url)}`
    );
    return response.data;
  },
};
